...
% Input numeric sector/zone identifier. 
% --> Sectors 1-18 are coastal AA sectors wrapping clockwise from the
% eastern side of the Peninsula around the continent to the western side. 
% id 19 is subpolar_ao, 20 is subpolar_io, 21 is subpolar po
%    22 is acc_ao, 23 is acc_io, 24 is acc_po


% Notice where the ouput saves
...
if length(sector)==2
    save(['ICE/ICETHICKNESS/Data/MAT_files/Final/orig_timescale/Sectors/recLenAv/sector',sector,'_reclenav.mat'], 'SIT', '-v7.3');
else
